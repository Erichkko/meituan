<template>
  <div class="seller-list-item">
    ...
    <div class="content">
      ...
      <ul class="activety">
        <li class="jian" v-show="item.shop_discount.code"><img src="../assets/images/others/jian.png" ><span>{{replacePrice}}</span></li>
        <li class="fan" v-show="item.shop_return_price.code"><img src="../assets/images/others/fan.png" ><span>{{"实际支付" + item.shop_return_price.min_price + "元返" + item.shop_return_price.dis_money +"元商家代金券"}}</span></li>
        <li class="fapiao" v-show="item.shop_return_invoice.code"><img src="../assets/images/others/piao.png" ><span>{{"本店支持开发票，开票金额" + item.shop_return_invoice.min_price + "元起"}}</span></li>
      </ul>
    </div>
